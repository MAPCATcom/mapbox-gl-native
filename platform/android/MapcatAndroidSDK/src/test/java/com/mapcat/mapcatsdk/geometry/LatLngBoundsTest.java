package com.mapcat.mapcatsdk.geometry;

import android.os.Parcelable;

import com.mapcat.mapcatsdk.constants.GeometryConstants;
import com.mapcat.mapcatsdk.exceptions.InvalidLatLngBoundsException;
...
public class LatLngBoundsTest {
  ...
  public void fromTileID() {
    ...
    Assert.assertEquals(GeometryConstants.MIN_LONGITUDE, bounds.getLonWest(), DELTA);
