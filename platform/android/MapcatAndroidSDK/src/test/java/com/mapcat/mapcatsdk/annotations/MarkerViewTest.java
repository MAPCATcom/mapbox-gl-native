...
import com.mapcat.mapcatsdk.exceptions.InvalidMarkerPositionException;
...
public class MarkerViewTest {
  ...
  public void testPosition() {
    ...
    Assert.assertEquals(marker.getPosition(), new LatLng(10, 12));
    Assert.assertEquals(markerOptions.getPosition(), new LatLng(10, 12));
  }
