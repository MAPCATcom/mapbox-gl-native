...
import com.mapcat.mapcatsdk.utils.MockParcel;
...
public class CameraPositionTest {
  ...
  public void testTypedArrayBuilder() {
    ...
    when(typedArray.getFloat(com.mapcat.mapcatsdk.R.styleable.mapbox_MapView_mapbox_cameraBearing, 0.0f)).thenReturn(bearing);
    when(typedArray.getFloat(com.mapcat.mapcatsdk.R.styleable.mapbox_MapView_mapbox_cameraTargetLat, 0.0f)).thenReturn(latitude);
    when(typedArray.getFloat(com.mapcat.mapcatsdk.R.styleable.mapbox_MapView_mapbox_cameraTargetLng, 0.0f)).thenReturn(longitude);
    when(typedArray.getFloat(com.mapcat.mapcatsdk.R.styleable.mapbox_MapView_mapbox_cameraZoom, 0.0f)).thenReturn(zoom);
    when(typedArray.getFloat(com.mapcat.mapcatsdk.R.styleable.mapbox_MapView_mapbox_cameraTilt, 0.0f)).thenReturn(tilt);
