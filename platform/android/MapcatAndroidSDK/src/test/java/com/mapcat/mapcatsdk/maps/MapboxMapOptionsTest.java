...
public class MapboxMapOptionsTest {
  ...
  public void testMinZoom() {
    Assert.assertEquals(MapboxConstants.MINIMUM_ZOOM, new MapboxMapOptions().getMinZoomPreference(), DELTA);
  ...
  public void testCamera() {
    ...
    Assert.assertEquals(new CameraPosition.Builder(position).build(), new MapboxMapOptions().camera(position).getCamera());
