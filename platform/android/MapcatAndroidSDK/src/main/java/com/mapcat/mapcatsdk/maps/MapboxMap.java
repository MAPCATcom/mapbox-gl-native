...
import com.mapcat.mapcatsdk.constants.MyLocationTracking;
...
import com.mapcat.mapcatsdk.style.layers.Filter;
import com.mapcat.mapcatsdk.style.layers.Layer;
import com.mapcat.mapcatsdk.style.light.Light;
import com.mapcat.mapcatsdk.style.sources.Source;
import com.mapcat.mapcatsdk.style.layers.SymbolLayer;
...
public final class MapboxMap {
   ...
   * {@link TrackingSettings#setDismissLocationTrackingOnGesture(boolean)} with false before
   ...
   * @param markerOptions A marker options object that defines how to render the marker
   * @return The {@code Marker} that was added to the map
   * @deprecated Use a {@link SymbolLayer} instead. An example of converting Android
