 ...
 * <p>
 * This occurs either when {@link Mapcat} is not correctly initialised or the provided Visualization
 * API key through {@link Mapcat#getInstance(Context, String)} isn't valid.
 * </p>
 *
...
public class MapcatConfigurationException extends RuntimeException {
  ...
  public MapcatConfigurationException() {
    super("\nUsing MapView requires setting a valid Visualization API key. Use Mapcat.getInstance(Context context, "
      + "String visualizationApiKey) to provide one. "
