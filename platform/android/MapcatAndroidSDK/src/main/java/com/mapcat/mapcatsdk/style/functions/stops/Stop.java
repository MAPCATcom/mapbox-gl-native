...
import com.mapcat.mapcatsdk.style.layers.PropertyValue;
import com.mapcat.mapcatsdk.style.functions.CompositeFunction;
...
public class Stop<I, O> {
  ...
  /**
   * Create a composite {@link Stop} for use in a {@link CompositeFunction}
   *
