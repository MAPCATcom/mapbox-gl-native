...
import com.mapcat.mapcatsdk.attribution.Attribution;
import com.mapcat.mapcatsdk.attribution.AttributionParser;
import com.mapcat.mapcatsdk.camera.CameraPosition;
import com.mapcat.mapcatsdk.style.sources.Source;
...
public class AttributionDialogManager implements View.OnClickListener, DialogInterface.OnClickListener {
  ...
  protected void showAttributionDialog(String[] attributionTitles) {
    ...
    builder.setTitle(com.mapcat.mapcatsdk.R.string.mapbox_attributionsDialogTitle);
    builder.setAdapter(new ArrayAdapter<>(context, com.mapcat.mapcatsdk.R.layout.mapbox_attribution_list_item, attributionTitles), this);
    builder.show();
  }
  ...
  private void showTelemetryDialog() {
    AlertDialog.Builder builder = new AlertDialog.Builder(context);
    builder.setTitle(com.mapcat.mapcatsdk.R.string.mapbox_attributionTelemetryTitle);
    builder.setMessage(com.mapcat.mapcatsdk.R.string.mapbox_attributionTelemetryMessage);
    builder.setPositiveButton(com.mapcat.mapcatsdk.R.string.mapbox_attributionTelemetryPositive, new DialogInterface.OnClickListener() {
      @Override
      public void onClick(DialogInterface dialog, int which) {
    ...
    builder.setNeutralButton(com.mapcat.mapcatsdk.R.string.mapbox_attributionTelemetryNeutral, new DialogInterface.OnClickListener() {
      @Override
      public void onClick(DialogInterface dialog, int which) {
        showWebPage(context.getResources().getString(com.mapcat.mapcatsdk.R.string.mapbox_telemetryLink));
        dialog.cancel();
      }
    });
    builder.setNegativeButton(com.mapcat.mapcatsdk.R.string.mapbox_attributionTelemetryNegative, new DialogInterface.OnClickListener() {
      @Override
      public void onClick(DialogInterface dialog, int which) {
  ...
  private void showWebPage(@NonNull String url) {
    try {
      ...
      Toast.makeText(context, com.mapcat.mapcatsdk.R.string.mapbox_attributionErrorNoBrowser, Toast.LENGTH_LONG).show();
    }
  }
