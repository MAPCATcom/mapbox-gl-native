  ...
  InfoWindow open(MapView mapView, Marker boundMarker, LatLng position, int offsetX, int offsetY) {
    ...
    if (view != null && mapboxMap != null) {
      ...
      if (view instanceof BubbleLayout) {
        ...
        float marginHorizontal = resources.getDimension(com.mapcat.mapcatsdk.R.dimen.mapbox_infowindow_margin);
        float tipViewOffset = resources.getDimension(com.mapcat.mapcatsdk.R.dimen.mapbox_infowindow_tipview_width) / 2;
