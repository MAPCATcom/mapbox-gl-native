...
public class InfoWindow {
  ...
  InfoWindow open(MapView mapView, Marker boundMarker, LatLng position, int offsetX, int offsetY) {
    ...
    if (view != null && mapboxMap != null) {
      ...
      if (view instanceof BubbleLayout) {
        ...
        float marginHorizontal = resources.getDimension(com.mapcat.mapcatsdk.R.dimen.mapcat_infowindow_margin);
        float tipViewOffset = resources.getDimension(com.mapcat.mapcatsdk.R.dimen.mapcat_infowindow_tipview_width) / 2;
  ...
  void adaptDefaultMarker(Marker overlayItem, MapboxMap mapboxMap, MapView mapView) {
    ...
    TextView titleTextView = ((TextView) view.findViewById(com.mapcat.mapcatsdk.R.id.infowindow_title));
    ...
    TextView snippetTextView = ((TextView) view.findViewById(com.mapcat.mapcatsdk.R.id.infowindow_description));
