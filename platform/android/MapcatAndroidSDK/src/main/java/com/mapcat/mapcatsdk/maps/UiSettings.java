...
import com.mapcat.mapcatsdk.utils.ColorUtils;
...
public final class UiSettings {
  ...
  private void initialiseCompass(MapboxMapOptions options, Resources resources) {
    ...
    if (options.getCompassImage() == null) {
      options.compassImage(ResourcesCompat.getDrawable(resources, com.mapcat.mapcatsdk.R.drawable.mapbox_compass_icon, null));
    }
