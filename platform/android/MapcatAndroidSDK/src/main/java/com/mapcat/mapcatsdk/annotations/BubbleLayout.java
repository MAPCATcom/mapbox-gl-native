...
public class BubbleLayout extends LinearLayout {
  ...
  public BubbleLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.mapcat_BubbleLayout);
    @ArrowDirection.Value
    int location = a.getInt(R.styleable.mapcat_BubbleLayout_mapcat_bl_arrowDirection,
      ArrowDirection.LEFT);
    arrowDirection = new ArrowDirection(location);
    arrowWidth = a.getDimension(R.styleable.mapcat_BubbleLayout_mapcat_bl_arrowWidth,
      convertDpToPixel(8, context));
    arrowHeight = a.getDimension(R.styleable.mapcat_BubbleLayout_mapcat_bl_arrowHeight,
      convertDpToPixel(8, context));
    arrowPosition = a.getDimension(R.styleable.mapcat_BubbleLayout_mapcat_bl_arrowPosition,
      convertDpToPixel(12, context));
    cornersRadius = a.getDimension(R.styleable.mapcat_BubbleLayout_mapcat_bl_cornersRadius, 0);
    bubbleColor = a.getColor(R.styleable.mapcat_BubbleLayout_mapcat_bl_bubbleColor, Color.WHITE);
    strokeWidth =
      a.getDimension(R.styleable.mapcat_BubbleLayout_mapcat_bl_strokeWidth, DEFAULT_STROKE_WIDTH);
    strokeColor = a.getColor(R.styleable.mapcat_BubbleLayout_mapcat_bl_strokeColor, Color.GRAY);
