...
import com.mapcat.mapcatsdk.utils.AnimatorUtils;
...
public class MarkerViewManager implements MapView.OnMapChangedListener {
   ...
   * <p>
   * The {@link MapboxMap.MarkerViewAdapter#onDeselect(MarkerView, View)}
   ...
   * Animate a MarkerView to a selected state.
   * <p>
   * The {@link MapboxMap.MarkerViewAdapter#onSelect(MarkerView, View, boolean)}
   * will be called to execute an animation.
   * </p>
   *
   * @param marker      the MarkerView object to select.
   ...
   * {@link MapboxMap.MarkerViewAdapter}. It's possible to remove
