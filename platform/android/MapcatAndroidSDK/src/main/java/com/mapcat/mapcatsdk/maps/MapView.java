...
import com.mapcat.mapcatsdk.constants.Style;
import com.mapcat.mapcatsdk.exceptions.MapcatConfigurationException;
import com.mapcat.mapcatsdk.maps.renderer.MapRenderer;
import com.mapcat.mapcatsdk.maps.renderer.glsurfaceview.GLSurfaceViewMapRenderer;
import com.mapcat.mapcatsdk.maps.renderer.textureview.TextureViewMapRenderer;
import com.mapcat.mapcatsdk.maps.widgets.CompassView;
import com.mapcat.mapcatsdk.maps.widgets.MyLocationView;
import com.mapcat.mapcatsdk.maps.widgets.MyLocationViewSettings;
import com.mapcat.mapcatsdk.net.ConnectivityReceiver;
import com.mapcat.mapcatsdk.storage.FileSource;
...
import static com.mapcat.mapcatsdk.maps.widgets.CompassView.TIME_MAP_NORTH_ANIMATION;
import static com.mapcat.mapcatsdk.maps.widgets.CompassView.TIME_WAIT_IDLE;
...
public class MapView extends FrameLayout {
  ...
  private void initialiseMap() {
    ...
    MarkerViewManager markerViewManager = new MarkerViewManager((ViewGroup) findViewById(com.mapcat.mapcatsdk.R.id.markerViewContainer));
  ...
  private void initialiseDrawingSurface(MapboxMapOptions options) {
    if (options.getTextureMode()) {
      ...
      GLSurfaceView glSurfaceView = (GLSurfaceView) findViewById(com.mapcat.mapcatsdk.R.id.surfaceView);
