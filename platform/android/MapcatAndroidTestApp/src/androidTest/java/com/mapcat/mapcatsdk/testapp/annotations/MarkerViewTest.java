...
import com.mapcat.mapcatsdk.testapp.model.annotations.TextMarkerViewOptions;
...
public class MarkerViewTest extends BaseActivityTest {
  ...
  private void addAdapter() {
    MapboxMapAction.invoke(mapboxMap, (uiController, mapboxMap) -> mapboxMap.getMarkerViewManager().addMarkerViewAdapter(
