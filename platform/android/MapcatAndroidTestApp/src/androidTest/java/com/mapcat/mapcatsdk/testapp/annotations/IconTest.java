package com.mapcat.mapcatsdk.testapp.annotations;
...
import com.mapcat.mapcatsdk.maps.IconManagerResolver;
import com.mapbox.mapboxsdk.maps.MapboxMap;
import com.mapcat.mapcatsdk.testapp.activity.BaseActivityTest;
import com.mapbox.mapboxsdk.testapp.activity.espresso.EspressoTestActivity;
import com.mapcat.mapcatsdk.testapp.utils.IconUtils;
...
public class IconTest extends BaseActivityTest {
  ...
  public void testAddRemoveMany() throws Exception {
    ...
    mapboxMap.addMarker(new MarkerOptions()
      .icon(iconFactory.fromResource(com.mapcat.mapcatsdk.testapp.R.drawable.mapbox_compass_icon))
      .position(new LatLng(4, 1))
    );
    mapboxMap.addMarker(new MarkerOptions()
      .icon(IconUtils.drawableToIcon(activity, com.mapcat.mapcatsdk.testapp.R.drawable.ic_stars,
        ResourcesCompat.getColor(activity.getResources(),
          com.mapcat.mapcatsdk.testapp.R.color.blueAccent, activity.getTheme())))
      .position(new LatLng(5, 1))
    );
    mapboxMap.addMarker(new MarkerOptions()
      .icon(iconFactory.fromResource(com.mapcat.mapcatsdk.testapp.R.drawable.ic_android))
