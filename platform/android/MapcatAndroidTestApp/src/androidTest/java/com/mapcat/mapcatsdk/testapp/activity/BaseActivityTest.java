package com.mapcat.mapcatsdk.testapp.activity;
...
import com.mapcat.mapcatsdk.testapp.utils.OnMapReadyIdlingResource;
...
public abstract class BaseActivityTest {
  ...
  public void beforeTest() {
    try {
      ...
      checkViewIsDisplayed(com.mapcat.mapcatsdk.testapp.R.id.mapView);
  ...
  protected void waitLoop(long waitTime) {
    onView(ViewMatchers.withId(com.mapcat.mapcatsdk.testapp.R.id.mapView)).perform(new LoopAction(waitTime));
  }
