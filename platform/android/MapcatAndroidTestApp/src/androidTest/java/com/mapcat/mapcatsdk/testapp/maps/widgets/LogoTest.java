package com.mapcat.mapcatsdk.testapp.maps.widgets;
...
public class LogoTest extends BaseActivityTest {
  ...
  public void testDefault() {
    validateTestSetup();
    onView(ViewMatchers.withId(com.mapcat.mapcatsdk.testapp.R.id.logoView)).check(matches(isDisplayed()));
  }
  ...
  public void testDisabled() {
    ...
    onView(ViewMatchers.withId(com.mapcat.mapcatsdk.testapp.R.id.logoView))
